...
//Added this to pass simulator connected variable to enable/disable dashGUI - jenyang
...
namespace NWH.VehiclePhysics2.VehicleGUI
{
    ...
    public class DashGUIController : MonoBehaviour
    {
        ...
        //jenyang
        public static float VehicleSpeedData;
        //jenyang
        ...
        private void Update()
        {
            ...
            if (vehicleController != null && _update)
            {
                if (useAnalogRpmGauge)
                {
                    ...
                    //Debug.Log("Engine RPM: " + vehicleController.powertrain.engine.RPM);
                }
                ...
                if (useDigitalSpeedGauge)
                {
                    ...
                    VehicleSpeedData = digitalSpeedGauge.numericalValue;
                }
                ...
                //jenyang
                //Debug.Log("Impearl Portable: " + ImpearlPortableIsConnected);
                //Debug.Log("Impearl: " + ImpearlSimulatorIsConnected);
                //Debug.Log("AV is Connected: " + AVIsConnected);
                //Debug.Log("Analog Rpm Gauge: " + useAnalogRpmGauge);
                //Debug.Log("Digital Rpm Gauge: " + useDigitalRpmGauge);
            ...
            //Jenyang
            //If trakracer is not connected, hide the dashboard
            if (!NWH.VehiclePhysics2.Input.VehicleInputHandler.CheckForImpearlPortable())
            {
                //Debug.Log("Connection data from Vehicle Input Handler Evaluates to false!!");
        ...
        //jenyang 
        //This static function can be called by other classes for use
        public static float PassSpeedData()
        {
