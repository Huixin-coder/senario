...
namespace NWH.VehiclePhysics2
{
    ...
    public class VehicleController : Vehicle
    {
        ...
        private UCL_Impearl.UDPSend  UdpSend;
        ...
        private void Start()
        {
            // UCL_Impearl.UDPSend[] UDPScripts = this.gameObject.GetComponents<UCL_Impearl.UDPSend>();
            ...
            //Logitech Wheel on Trakracer - Jenyang
            LogitechGSDK.LogiSteeringInitialize(false);
            //Debug.Log("Steering Wheel Started");
        ...
        public void Update()
        {
            ...
            if (UdpSend){
                // TODO ////////////////////////////////////////////////////////////////////////////////////////////////
                // quick fix: Steering parameter is only transferred when in manual driving, otherwise it will disable
                // autonomous mode automatically when moving the steering wheel
                // what we need is a function that predicts the steering wheel behaviour when in autonomous mode and
                // detects if there is a discrepancy => could that be a thesis?
                ////////////////////////////////////////////////////////////////////////////////////////////////////////
                if (!input.AVIsConnected) {
                    UdpSend.UpdateParameterValue("MSteer", steering.CalcForceFeedbackSteeringTorque(this));
                }
                UdpSend.UpdateParameterValue("vCar", Speed);
                UdpSend.UpdateParameterValue("XAP_nEngine", powertrain.engine.RPM);
                UdpSend.UpdateParameterValue("XAP_Ngear", powertrain.transmission.Gear);
                UdpSend.UpdateParameterValue("NSteerModeExt", 0);
            }
