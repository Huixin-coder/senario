...
namespace NWH.VehiclePhysics2.Sound
{
    ...
    public class SoundManager : VehicleComponent
    {
        ...
        //Car interior sound - jenyang
        [Tooltip("Sounds from the car Interior (maybe radio? idk)")]
        public CarInteriorComponent carInteriorComponent = new CarInteriorComponent();

        [Tooltip("Radio? People talking Noises? Maybe")]
        public CarRadioComponent carRadio = new CarRadioComponent();
        ...
        public override void Initialize()
        {
            ...
            carInteriorComponent.InitializeSoundComponent(otherMixerGroup, otherSourceGO);
            carRadio.InitializeSoundComponent(otherMixerGroup, otherSourceGO);
            //added sound component for carInteriorComponent & carRadio - jenyang
