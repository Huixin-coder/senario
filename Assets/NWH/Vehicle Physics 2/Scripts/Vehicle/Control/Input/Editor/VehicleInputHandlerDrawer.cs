...
namespace NWH.VehiclePhysics2.Input
{
    ...
    public class VehicleInputHandlerDrawer : ComponentNUIPropertyDrawer
    {
        ...
        public override bool OnNUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            drawer.BeginSubsection("Impearl Sim Setup");
                drawer.Field("ImpearlSimulatorIsConnected");
            drawer.EndSubsection();
            
            drawer.BeginSubsection("Autonomous Vehicle Setup");
                drawer.Field("AVIsConnected");
            drawer.EndSubsection();

            drawer.BeginSubsection("Impearl Portable Sim (Trakracer) Setup");
                drawer.Field("ImpearlPortableIsConnected");
            drawer.EndSubsection();
